...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/5NJeWEeBonlrBhBrVHEz/multiyazychnost/ispravlenie-oshibok-v-perevode
---
...
* **Через пулреквест на GitHub** — отредактируйте нужный `.po`-файл (`system/locale/<язык>.po` или `modules/<вендор>/<модуль>/locale/<язык>.po`) и отправьте пулреквест. Подробнее — на странице [Перевод JohnCMS на другие языки](perevod-johncms-na-drugie-yazyki.md).

Для исправления через Crowdin откройте [https://translate.johncms.com/](https://translate.johncms.com/) и авторизуйтесь и выберите нужный язык.\
После этого откроется окно с выбором модуля.

![Список модулей для перевода](<../.gitbook/assets/image (10).png>)
...
![Список фраз для перевода](<../.gitbook/assets/image (7).png>)
