...
Переводы синхронизируются между Crowdin и репозиторием в обе стороны, поэтому оба способа равнозначны — выбирайте удобный.
...
* После принятия пулреквеста перевод автоматически синхронизируется с Crowdin, так что конфликтов между способами не возникает.
