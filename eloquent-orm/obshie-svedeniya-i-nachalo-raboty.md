...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/5NJeWEeBonlrBhBrVHEz/eloquent-orm/obshie-svedeniya-i-nachalo-raboty
---
...
В папке **src/Domain/Models** создайте файл **Post.php** со следующим содержимым

{% code title="src/Domain/Models/Post.php" %}
```php
<?php
