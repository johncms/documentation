...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/5NJeWEeBonlrBhBrVHEz/obshie-svedeniya/konfiguracionnye-faily-configs
---
...
![Список конфигурационных файлов в JohnCMS](<../.gitbook/assets/image (5).png>)
...
Это вернёт содержимое всех конфигурационных файлов из папки **config/autoload**.
{% endhint %}
...
Для удобства можете создать файл **test.php** в папке **public** — она является корнем сайта,
поэтому по HTTP доступны только файлы из неё:
