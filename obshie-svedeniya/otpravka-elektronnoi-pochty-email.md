...
То же самое доступно в админке в разделе задач обслуживания — «Update the database». Новые установки получают нужные колонки сразу. Подробности — в разделе [Миграции базы данных](../baza-dannykh/migracii.md).
